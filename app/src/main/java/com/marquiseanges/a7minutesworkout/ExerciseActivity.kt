...
import com.marquiseanges.a7minutesworkout.databinding.DialogCustomBackConfirmationBinding
import java.util.*
...
//variable
    ...
    private fun setupRestView() {
        ...
        try {
            val soundURI =
                Uri.parse("android.resource://com.marquiseanges.a7minutesworkout/" + R.raw.press_start)
